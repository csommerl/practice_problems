...
I liked the way [Grokking the coding interview](https://designgurus.org/course/grokking-the-coding-interview) organized problems into learnable patterns. However, the course is expensive and the majority of the time the problems are copy-pasted from leetcode. As the explanations on leetcode are usually just as good, the course really boils down to being a glorified curated list of leetcode problems.
